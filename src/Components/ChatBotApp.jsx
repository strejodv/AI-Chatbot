    ...
    const sendMessage = async () => {
      ...
      const response = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        headers: {
          ...
          Authorization: `Bearer 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`,
        },
        body: JSON.stringify({
          model: "gpt-3.5-turbo",
  ...
  <div className="chat-app">
    ...
    <div className="chat-window">
      <div className="chat-title">
        <h3>Chat with AI</h3>
        <i className="bx bx-menu" onClick={() => setShowChatList(!showChatList)}></i>
      ...
      <div className="chat">
        ...
        <form className="msg-form" onSubmit={() => e.preventDefault()}>
            <i className="bx bxs-smile" onClick={() => setShowEmojiPicker((prev) => !prev)}></i>
            {showEmojiPicker && (
              <div className='picker'><Picker data={data} onEmojiSelect={handleEmojiSelect}/></div>
            )}
            <input type="text" className="msg-input" placeholder="Type a message..." 
            value={inputValue} onChange={handleInputChange} onKeyDown={handleKeyDown} onFocus={() => setShowEmojiPicker(false)}></input>
